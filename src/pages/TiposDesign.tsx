    ...
    return (
        <section>
            ...
            <ul>
                ...
                <li>Criação de logotipos, cartazes, embalagens e materiais impressos/digitais.</li>
            </ul>
            ...
            <ul>
                <li>Criação visual da interface: botões, ícones, cores e tipografia.</li>
